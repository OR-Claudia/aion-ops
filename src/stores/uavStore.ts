...
interface UAVStoreState {
  uavs: UAVData[];
  filteredUAVs: UAVData[];
  selectedUAV: UAVData | null;
  // Actions
  setFilteredUAVs: (uavs: UAVData[]) => void;
  setSelectedUAV: (uav: UAVData | null) => void;
  getUAVById: (id: string) => UAVData | undefined;
  filterUAVs: (filters: { brand?: string; status?: string; missionType?: string }) => void;
}
...
const initialUAVData: UAVData[] = [
  {
    ...
    type: "tactical",
    status: "damage",
    image: "https://api.builder.io/api/v1/image/assets/TEMP/4f096b02ea6202e65bd14e12c238cb997a8a618d?width=554",
    ...
    description: "Medium-range tactical UAV used for reconnaissance and artillery adjustment.",
  ...
  },
  {
    ...
    type: "combat",
    status: "active",
    image: "https://api.builder.io/api/v1/image/assets/TEMP/f476cc02d51fe1eb0607cb92d090efc91a3f3cf6?width=554",
    lastContact: "N/A",
    readyForFlight: "Yes",
    lastKnownLocation: "N/A",
    location: "Hangar H6",
  ...
  },
  {
    ...
    type: "tactical",
    status: "standby",
    image: "https://api.builder.io/api/v1/image/assets/TEMP/309b73395a37595a2f2e74d4e6787fbbcdf00765?width=554",
  ...
  },
  {
    ...
    type: "combat",
    status: "destroyed",
    image: "https://api.builder.io/api/v1/image/assets/TEMP/e11088e3e85ed9a71bb357fdf440abc0184c8908?width=552",
  ...
  },
  {
    ...
    type: "tactical",
    status: "damage",
    image: "https://api.builder.io/api/v1/image/assets/TEMP/4c287b89be0c407640c8f81eebc78453161de70a?width=554",
    lastContact: "Yesterday 08:44 am",
    readyForFlight: "Yes",
  ...
  },
  {
    ...
    type: "combat",
    status: "engaged",
    image: "https://api.builder.io/api/v1/image/assets/TEMP/668c75c5c826b3fd84337434710142918b6a9c7e?width=554",
  ...
  },
  {
    ...
    type: "combat",
    status: "offline",
    image: "https://api.builder.io/api/v1/image/assets/TEMP/c88d5aaf8fcbbac5b9b290c77f03d8e89504a97f?width=554",
  ...
  },
  {
    ...
    type: "tactical",
    status: "engaged",
    image: "https://api.builder.io/api/v1/image/assets/TEMP/cdbb50c6cf6bfd1fb926deb3b4187dc355868f6c?width=554",
  ...
  },
  {
    ...
    type: "recon",
    status: "active",
    image: "https://api.builder.io/api/v1/image/assets/TEMP/666fff2ac2853f8097ba262a6c17a165b9b4da09?width=554",
    lastContact: "Yesterday 08:44 am",
    readyForFlight: "Yes",
    lastKnownLocation: "Hangar H6",
    location: "Hangar H6",
...
export const useUAVStore = create<UAVStoreState>((set, get) => ({
  uavs: initialUAVData,
  filteredUAVs: initialUAVData,
  selectedUAV: null,

  setFilteredUAVs: (uavs: UAVData[]) => set({ filteredUAVs: uavs }),

  setSelectedUAV: (uav: UAVData | null) => set({ selectedUAV: uav }),

  getUAVById: (id: string) => {
    const { uavs } = get();
    return uavs.find(uav => uav.id === id);
  },

  filterUAVs: (filters: { brand?: string; status?: string; missionType?: string }) => {
    const { uavs } = get();
    let filtered = uavs;
