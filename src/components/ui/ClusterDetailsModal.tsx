...
const ClusterDetailsModal: React.FC<ClusterDetailsModalProps> = ({
  ...
  const handleMinimize = () => {
    // For now, just close the modal. Could be enhanced to minimize to a smaller state
    onClose();
  };
  ...
  return (
    <div className="fixed inset-0 z-50 pointer-events-auto">
      ...
      <div
        ref={modalRef}
        className="absolute w-[551px] min-h-[462px] rounded-[0px_10px_10px_0px] border-[1.5px] border-[rgba(211,251,216,0.5)] bg-black/60 backdrop-blur-[2px]"
        style={{
          left: `${position.x}px`,
          top: `${position.y}px`,
        }}
      >
        ...
        <div
          className={`flex items-center justify-between px-[27px] pt-[22px] mb-[24px] select-none ${
