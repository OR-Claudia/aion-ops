...
const DetectionItem: React.FC<DetectionItemProps> = ({
	...
	return (
		<div
			className="w-[290px] h-26 mb-[1px] relative cursor-pointer hover:opacity-80 transition-opacity"
			onClick={onClick}
		>
			<div
				className={`w-[283px] h-24 bg-[#242B2C] rounded-[0px_10px_10px_10px] absolute left-0 top-0 ${
