...
// Zamockowane dane UAV (przeniesione z UAVListPage)
const uavData: UAVData[] = [
	{
		...
		controlUnit: "Amanda Magiera (EMP101)",
	...
	},
	{
		...
		type: "combat",
		status: "active",
		image: "src/assets/img/Kuna_1.jpg",
		lastContact: "N/A",
		readyForFlight: "Yes",
		lastKnownLocation: "N/A",
		location: "Building H6",
		...
		controlUnit: "Dagmara Popowska (EMP102)",
	...
	},
	{
		...
		controlUnit: "Kamil Kisielewski (EMP103)",
		mission: "Standby",
	...
	},
	{
		...
		controlUnit: "Leopold Bartczak (EMP105)",
		mission: "Engagement",
	...
	},
	{
		...
		controlUnit: "Izydor Gall (EMP106)",
		mission: "Reconnaissance",
	...
	},
	{
		...
		controlUnit: "Władysław Kolano (EMP107)",
		mission: "Reconnaissance",
	...
	},
	{
		...
		controlUnit: "Kazimiera Mikołajczak (EMP108)",
	...
	},
	{
		...
		controlUnit: "Andrzej Matulewicz (EMP109)",
		mission: "Standby",
	...
	},
	{
		...
		controlUnit: "Zdzisław Dutko (EMP110)",
		mission: "Patrol",
	...
	},
	{
		...
		controlUnit: "Elwira Działo (EMP111)",
	...
	},
	{
		...
		controlUnit: "Marcel Mikołajewski (EMP112)",
		mission: "Standby",
	...
	},
	{
		...
		controlUnit: "Sławomir Hodak (EMP113)",
		mission: "Engagement",
...
/**
 * Pobierz listę UAV (mockowane API)
 */
export async function getUAVList(): Promise<UAVData[]> {
	await delay(400);
	return uavData;
}

/**
 * Pobierz detale UAV po id (mockowane API)
 */
export async function getUAVById(id: string): Promise<UAVData | undefined> {
	await delay(250);
	return uavData.find((uav) => uav.id === id);
}
